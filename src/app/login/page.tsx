      ...
      <Card className="w-full max-w-md border-border bg-card/80 backdrop-blur-md rounded-none shadow-2xl relative z-10">
        <CardHeader className="space-y-3 border-b border-border/50 pb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] text-muted-foreground font-mono">ACCESS_PROTOCOL</span>
          </div>
          <CardTitle className="text-2xl font-black tracking-tighter uppercase italic">Login</CardTitle>
        ...
        <CardFooter className="flex flex-col space-y-4 border-t border-border/50 pt-6">
          <div className="text-[10px] text-center text-muted-foreground uppercase tracking-[0.2em]">
            ...
            <Link href="/signup" className="text-foreground hover:text-primary transition-colors font-bold underline-offset-4 hover:underline">
              Sign up
            </Link>
          </div>
        </CardFooter>
